package com.israilbony.jsonreader;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            myDataArray=new String[toppingArray.length()];
            for(int i=0;i<toppingArray.length();i++)
            {
               JSONObject typeObject=toppingArray.getJSONObject(i);
                myDataArray[i]=typeObject.getString("type");
            }
